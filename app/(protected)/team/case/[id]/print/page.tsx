                    ...
                    <div className="space-y-8 relative">
                        ...
                        <StepCard
                            ...
                            action={
                                mainForm && (
                                    <button
                                        onClick={() => handlePrint(mainForm.file_path ?? undefined)}
                        ...
                        <StepCard
                            ...
                            action={
                                photosDoc && (
                                    <button
                                        onClick={() => handlePrint(photosDoc.file_path ?? undefined)}
                            ...
                            <div className="bg-white border-2 border-slate-200 rounded-[2.5rem] p-8 shadow-sm">
                                ...
                                <div className="space-y-4">
                                    <EvidenceItem
                                        ...
                                        onPrint={() => handlePrint(passportDoc?.file_path ?? undefined)}
                                    />
                                    <EvidenceItem
                                        ...
                                        onPrint={() => handlePrint(i94Doc?.file_path ?? undefined)}
                                    />
                                    <EvidenceItem
                                        ...
                                        onPrint={() => handlePrint(birthCertDoc?.file_path ?? undefined)}
                                        hasAlert
                                    />
                                </div>
                            </div>
