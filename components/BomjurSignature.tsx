...
export default function BomjurSignature() {
    return (
        <div className="fixed bottom-4 right-4 z-[5000] flex items-center gap-3 px-5 py-2.5 bg-white shadow-md rounded-full border border-slate-200 select-none overflow-hidden hover:shadow-lg transition-all duration-300">
